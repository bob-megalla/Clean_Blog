                                    ...
                                    <form method="POST" Action="<?= '?admin=edit_category' ?>">
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="name" name="name" value="<?= $Selected_Cat['name'] ?>"
                                                    placeholder="Enter Category Name">
                                                    <input type="text" class="form-control" style="display:none" name="id" value="<?= $Selected_Cat['id'] ?>">
                                            </div>
